-- ================================================================
-- FIX4HOME SAMPLE DATA
-- Safe, minimal, coherent seed for local/dev environments
-- Assumes current DB is ${DB_NAME} provided by MYSQL_DATABASE
-- ================================================================

-- Clear tables (idempotent-ish for dev). Comment out if not desired.
...
-- Keep services and skills (these may be pre-seeded by schema). Refill if empty.
SET FOREIGN_KEY_CHECKS = 1;

-- ================================================================
-- Users
-- Passwords are plain for demo; in real app, the backend hashes.
-- ================================================================
...
SET @aliceAddr = LAST_INSERT_ID() - 1; -- first of two rows inserted
SET @bobAddr   = LAST_INSERT_ID();     -- second row id
...
-- Ensure base services and skills exist; insert minimal if missing
...
-- ================================================================
-- Payments, Feedbacks, Notifications
-- ================================================================
